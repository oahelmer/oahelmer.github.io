...
layout: page
title: About Me
subtitle: Cybernetics and Robotics Student at NTNU
---
...
My primary technical interests center around control barrier functions, model predictive control, robotic vision, robotic perception, and information/sensor fusion. I enjoy exploring how underwater vehicles and autonomous systems sense and navigate complex environments.
...
* **R&D Target tracking:** Team leader for a target tracking initiative proposed by me, to track multiple ROVs underwater using a 3D-Sonar. Also developed a proof of concept of velocity and position estimation for an ROV equiped with only the 3D-sonar.
